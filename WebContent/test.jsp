			...
			<div class="shoppro">
				...
				<div class="shopnice" name="0">
					...
					<div class="shopimgnice"><span id="isotc">otc</span>
						...
						<p>采购价：￥<span id="dispri">${order.nprice}</span></p>
						<p>当前库存：<span id="shopkuc" st="2" ty="0"><c:if test="${order.smctag==1}">有货</c:if><c:if test="${p.smctag==0}">缺货</c:if></span></p>
					      <p>商品介绍：${order.sdescription}</p>
